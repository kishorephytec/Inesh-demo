...
// <o SL_CLI_VCOM_TASK_PRIORITY> CLI instance task priority
...
// <o SL_CLI_VCOM_TASK_STACK_SIZE> Task stack size
// <i> Default: 400
// <i> Stack size for the CLI task in words.
  #define SL_CLI_VCOM_TASK_STACK_SIZE       400

// <o SL_CLI_VCOM_TASK_START_DELAY_MS> CLI task start delay
// <i> Default: 0
