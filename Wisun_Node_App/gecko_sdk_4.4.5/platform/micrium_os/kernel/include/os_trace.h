...
#if defined(SL_CATALOG_SYSTEMVIEW_TRACE_PRESENT) || (defined(OS_CFG_TRACE_EN) && (OS_CFG_TRACE_EN == DEF_ENABLED))
...
#ifndef  OS_TRACE_ON_IDLE_ENTER
#define  OS_TRACE_ON_IDLE_ENTER()
#endif
