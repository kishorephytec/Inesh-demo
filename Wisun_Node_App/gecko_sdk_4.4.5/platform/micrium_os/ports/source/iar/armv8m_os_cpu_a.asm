...
;*               Toolchain : IAR EWARM
;*     
;* @note     (2) This port supports the ARM Cortex-M33 architecture.
;********************************************************************************************************
...
OSStartHighRdy
    ...
    MSR     PSPLIM, R0                                          ; PSPLIM = 0 before changing the PS
...
.update_msp_idle:
    ...
    MOV32   LR, #0xFFFFFFB8                                     ; Exception return uses master stack/process mode/basic frame security state/stack NS
#else
