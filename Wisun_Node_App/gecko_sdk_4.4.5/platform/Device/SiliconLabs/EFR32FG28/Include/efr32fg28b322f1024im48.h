 ...
 *
 *****************************************************************************/
#ifndef EFR32FG28B322F1024IM48_H
#define EFR32FG28B322F1024IM48_H
...
/**************************************************************************//**
 * @defgroup EFR32FG28B322F1024IM48 EFR32FG28B322F1024IM48
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  /******  EFR32FG28 Peripheral Interrupt Numbers ******************************************/
  ...
  VDAC0_IRQn             = 55, /*!< 55 EFR32 VDAC0 Interrupt */
  ...
  AHB2AHB0_IRQn          = 76, /*!< 76 EFR32 AHB2AHB0 Interrupt */
  AHB2AHB1_IRQn          = 77, /*!< 77 EFR32 AHB2AHB1 Interrupt */
  MVP_IRQn               = 78, /*!< 78 EFR32 MVP Interrupt */
} IRQn_Type;

/**************************************************************************//**
 * @defgroup EFR32FG28B322F1024IM48_Core EFR32FG28B322F1024IM48 Core
 * @{
...
/** @} End of group EFR32FG28B322F1024IM48_Core */

/**************************************************************************//**
* @defgroup EFR32FG28B322F1024IM48_Part EFR32FG28B322F1024IM48 Part
* @{
******************************************************************************/
...
#if !defined(EFR32FG28B322F1024IM48)
#define EFR32FG28B322F1024IM48    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                                        "EFR32FG28B322F1024IM48" /**< Part Number */
...
#define _SILICON_LABS_32B_SERIES_2_CONFIG_8                                                     /** Product Config Identifier */
#define _SILICON_LABS_32B_SERIES_2_CONFIG                  8                                    /** Product Config Identifier */
#define _SILICON_LABS_GECKO_INTERNAL_SDID                  235                                  /** Silicon Labs internal use only */
#define _SILICON_LABS_GECKO_INTERNAL_SDID_235                                                   /** Silicon Labs internal use only */
...
#define RDMEM_FRCRAM_S_MEM_SIZE                            (0x00002000UL) /** RDMEM_FRCRAM_S_MEM available address space */
#define RDMEM_FRCRAM_S_MEM_END                             (0xA0007FFFUL) /** RDMEM_FRCRAM_S_MEM end address */
#define RDMEM_FRCRAM_S_MEM_BITS                            (0xEUL)        /** RDMEM_FRCRAM_S_MEM used bits */
...
#define RDMEM_FRCRAM_FRCRAM_MEM_SIZE                       (0x00002000UL) /** RDMEM_FRCRAM_FRCRAM_MEM available address space */
#define RDMEM_FRCRAM_FRCRAM_MEM_END                        (0xB0007FFFUL) /** RDMEM_FRCRAM_FRCRAM_MEM end address */
#define RDMEM_FRCRAM_FRCRAM_MEM_BITS                       (0xEUL)        /** RDMEM_FRCRAM_FRCRAM_MEM used bits */
#define RDMEM_FRCRAM_NS_MEM_BASE                           (0xB0006000UL) /** RDMEM_FRCRAM_NS_MEM base address */
#define RDMEM_FRCRAM_NS_MEM_SIZE                           (0x00002000UL) /** RDMEM_FRCRAM_NS_MEM available address space */
#define RDMEM_FRCRAM_NS_MEM_END                            (0xB0007FFFUL) /** RDMEM_FRCRAM_NS_MEM end address */
#define RDMEM_FRCRAM_NS_MEM_BITS                           (0xEUL)        /** RDMEM_FRCRAM_NS_MEM used bits */

/** Flash and SRAM limits for EFR32FG28B322F1024IM48 */
...
#define EXT_IRQ_COUNT                                      79             /**< Number of External (NVIC) interrupts */
...
#define GPIO_THMSW_EN_PRIMARY_PIN                          11U           /**< Pin of THMSW_EN_PRIMARY.*/
...
#define GPIO_THMSW_HALFSWITCH_PRIMARY_PIN                  11U           /**< Pin of THMSW_HALFSWITCH_PRIMARY.*/
...
#define LCD_SEG20_PORT                                     GPIO_PA_INDEX /**< Port of SEG20.*/
#define LCD_SEG20_PIN                                      9U            /**< Pin of SEG20.*/
#define LCD_SEG21_PORT                                     GPIO_PA_INDEX /**< Port of SEG21.*/
#define LCD_SEG21_PIN                                      10U           /**< Pin of SEG21.*/
...
#include "system_efr32fg28.h" /* System Header File */

/** @} End of group EFR32FG28B322F1024IM48_Part */

/**************************************************************************//**
 * @defgroup EFR32FG28B322F1024IM48_Peripheral_TypeDefs EFR32FG28B322F1024IM48 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "efr32fg28_scratchpad.h"
#include "efr32fg28_emu.h"
#include "efr32fg28_cmu.h"
#include "efr32fg28_hfrco.h"
#include "efr32fg28_fsrco.h"
#include "efr32fg28_dpll.h"
#include "efr32fg28_lfxo.h"
#include "efr32fg28_lfrco.h"
#include "efr32fg28_ulfrco.h"
#include "efr32fg28_msc.h"
#include "efr32fg28_icache.h"
#include "efr32fg28_prs.h"
#include "efr32fg28_gpio.h"
#include "efr32fg28_ldma.h"
#include "efr32fg28_ldmaxbar.h"
#include "efr32fg28_timer.h"
#include "efr32fg28_usart.h"
#include "efr32fg28_burtc.h"
#include "efr32fg28_i2c.h"
#include "efr32fg28_syscfg.h"
#include "efr32fg28_buram.h"
#include "efr32fg28_gpcrc.h"
#include "efr32fg28_dcdc.h"
#include "efr32fg28_mailbox.h"
#include "efr32fg28_eusart.h"
#include "efr32fg28_sysrtc.h"
#include "efr32fg28_lcd.h"
#include "efr32fg28_keyscan.h"
#include "efr32fg28_mpahbram.h"
#include "efr32fg28_lcdrf.h"
#include "efr32fg28_pfmxpprf.h"
#include "efr32fg28_aes.h"
#include "efr32fg28_smu.h"
#include "efr32fg28_letimer.h"
#include "efr32fg28_iadc.h"
#include "efr32fg28_acmp.h"
#include "efr32fg28_vdac.h"
#include "efr32fg28_pcnt.h"
#include "efr32fg28_lesense.h"
#include "efr32fg28_hfxo.h"
#include "efr32fg28_wdog.h"
#include "efr32fg28_semailbox.h"
#include "efr32fg28_mvp.h"
#include "efr32fg28_devinfo.h"

/* Custom headers for LDMAXBAR and PRS mappings */
#include "efr32fg28_prs_signals.h"
#include "efr32fg28_dma_descriptor.h"
#include "efr32fg28_ldmaxbar_defines.h"

/** @} End of group EFR32FG28B322F1024IM48_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32FG28B322F1024IM48_Peripheral_Base EFR32FG28B322F1024IM48 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32FG28B322F1024IM48_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32FG28B322F1024IM48_Peripheral_Declaration EFR32FG28B322F1024IM48 Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32FG28B322F1024IM48_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32FG28B322F1024IM48_Peripheral_Parameters EFR32FG28B322F1024IM48 Peripheral Parameters
 * @{
...
#define GPIO_NUM_EVEN_PA                        0x8UL       /**> Num of even pins port A */
#define GPIO_NUM_EVEN_PB                        0x4UL       /**> Num of even pins port B */
#define GPIO_NUM_EVEN_PC                        0x6UL       /**> Num of even pins port C */
#define GPIO_NUM_EVEN_PD                        0x8UL       /**> Num of even pins port D */
#define GPIO_NUM_EXT_INT                        0x10UL      /**> New Param */
#define GPIO_NUM_EXT_INT_L                      0x8UL       /**> New Param */
#define GPIO_NUM_EXT_INT_U                      0x8UL       /**> New Param */
#define GPIO_NUM_EXT_INT_U_ZERO                 0x0UL       /**> New Param */
#define GPIO_NUM_ODD_PA                         0x7UL       /**> Num of odd pins port A */
#define GPIO_NUM_ODD_PB                         0x4UL       /**> Num of odd pins port B */
#define GPIO_NUM_ODD_PC                         0x6UL       /**> Num of odd pins port C */
#define GPIO_NUM_ODD_PD                         0x8UL       /**> Num of odd pins port D */
...
#define GPIO_PORT_C_WIDTH                       0xCUL       /**> Port C Width */
#define GPIO_PORT_C_WIDTH_ZERO                  0x0UL       /**> Port C Width is Zero */
#define GPIO_PORT_C_WL                          0x8UL       /**> New Param */
#define GPIO_PORT_C_WU                          0x4UL       /**> New Param */
#define GPIO_PORT_C_WU_ZERO                     0x0UL       /**> New Param */
#define GPIO_PORT_D_WIDTH                       0x10UL      /**> Port D Width */
#define GPIO_PORT_D_WIDTH_ZERO                  0x0UL       /**> Port D Width is Zero */
#define GPIO_PORT_D_WL                          0x8UL       /**> New Param */
#define GPIO_PORT_D_WU                          0x8UL       /**> New Param */
#define GPIO_PORT_D_WU_ZERO                     0x0UL       /**> New Param */
#define GPIO_SEGALLOC_WIDTH                     0x1CUL      /**> New Param */
...
#define SYSCFG_CHIP_PARTNUMBER                  0x2UL       /**> Chip Part Number */
#define SYSCFG_DEMODRAM_INST_COUNT              0x1UL       /**>  */
#define SYSCFG_FRCRAM_INST_COUNT                0x2UL       /**>  */
...
#define LCD_OCTAPLEX                            0x1UL       /**> None */
#define LCD_SEGASCOM_NUM                        0x4UL       /**> None */
#define LCD_NO_UPPER_SEGMENTS                   0x0UL       /**>  */
#define LCD_SEG_NUM                             0x1CUL      /**> None */
#define LCD_SEGASCOM_SEGSTART                   0x18UL      /**>  */
...
#define SMU_NUM_PPU_PERIPHS                     0x3AUL      /**> Number of PPU Peripherals */
#define SMU_NUM_PPU_PERIPHS_MOD_32              0x1AUL      /**> Number of PPU Peripherals (mod 32) */
#define SMU_NUM_PPU_PERIPHS_SUB_32              0x1AUL      /**> Number of PPU peripherals minus 32 */
...
#define RDMEM_FRC_BANK1_SIZE                    0x1000UL    /**> FRC_RAM_BANK1_SIZE */
...
#define RDMEM_FRC_NUM_BANK                      0x2UL       /**> FRC_NUM_BANK */
#define RDMEM_FRC_RAMADDRBITS                   0xDUL       /**> FRC RAM ADDRBITS */
...
#define RDMEM_SEQ_BANK0_SIZE                    0x4000UL    /**> SEQ_RAM_BANK0_SIZE */
...
#define RDMEM_SEQ_RAMADDRMINBITS                0xEUL       /**> SEQ RAM address bits for one bank */
...
/** @} End of group EFR32FG28B322F1024IM48_Peripheral_Parameters  */

/** @} End of group EFR32FG28B322F1024IM48 */
/** @}} End of group Parts */
