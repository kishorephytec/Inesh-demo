/**************************************************************************//**
 * @file
 * @brief EFR32FG28 LDMAXBAR register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32FG28_LDMAXBAR_H
#define EFR32FG28_LDMAXBAR_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG28_LDMAXBAR LDMAXBAR
 * @{
 * @brief EFR32FG28 LDMAXBAR Register Declaration.
 *****************************************************************************/
...
/** @} End of group EFR32FG28_LDMAXBAR */

/**************************************************************************//**
 * @addtogroup EFR32FG28_LDMAXBAR
 * @{
 * @defgroup EFR32FG28_LDMAXBAR_BitFields LDMAXBAR Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for LDMAXBAR IPVERSION */
#define _LDMAXBAR_IPVERSION_RESETVALUE           0x00000006UL                                 /**< Default value for LDMAXBAR_IPVERSION        */
...
#define _LDMAXBAR_IPVERSION_IPVERSION_DEFAULT    0x00000006UL                                 /**< Mode DEFAULT for LDMAXBAR_IPVERSION         */
...
/** @} End of group EFR32FG28_LDMAXBAR_BitFields */
/** @} End of group EFR32FG28_LDMAXBAR */
/** @} End of group Parts */

#endif // EFR32FG28_LDMAXBAR_H
