/**************************************************************************//**
 * @file
 * @brief EFR32FG28 CMU register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32FG28_CMU_H
#define EFR32FG28_CMU_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG28_CMU CMU
 * @{
 * @brief EFR32FG28 CMU Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  uint32_t       RESERVED25[857U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED34[27U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED40[31U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED51[857U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED68[5U];                /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED73[3U];                /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED77[857U];              /**< Reserved for future use                            */
  __IM uint32_t  IPVERSION_TGL;                 /**< IP version ID                                      */
  uint32_t       RESERVED78[1U];                /**< Reserved for future use                            */
  __IM uint32_t  STATUS_TGL;                    /**< Status Register                                    */
  uint32_t       RESERVED79[1U];                /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED81[10U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED82[2U];                /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED85[3U];                /**< Reserved for future use                            */
  __IOM uint32_t EXPORTCLKCTRL_TGL;             /**< Export Clock Control                               */
  uint32_t       RESERVED86[27U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED98[3U];                /**< Reserved for future use                            */
  __IOM uint32_t PCNT0CLKCTRL_TGL;              /**< Pulse counter 0 Clock Control                      */
  uint32_t       RESERVED99[3U];                /**< Reserved for future use                            */
  __IOM uint32_t RADIOCLKCTRL_TGL;              /**< Radio Clock Control                                */
  uint32_t       RESERVED100[3U];               /**< Reserved for future use                            */
  __IOM uint32_t LESENSEHFCLKCTRL_TGL;          /**< LESENSE HF Clock Control                           */
  uint32_t       RESERVED101[1U];               /**< Reserved for future use                            */
  uint32_t       RESERVED102[1U];               /**< Reserved for future use                            */
} CMU_TypeDef;
/** @} End of group EFR32FG28_CMU */

/**************************************************************************//**
 * @addtogroup EFR32FG28_CMU
 * @{
 * @defgroup EFR32FG28_CMU_BitFields CMU Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for CMU IPVERSION */
#define _CMU_IPVERSION_RESETVALUE                  0x00000006UL                            /**< Default value for CMU_IPVERSION             */
...
#define _CMU_IPVERSION_IPVERSION_DEFAULT           0x00000006UL                            /**< Mode DEFAULT for CMU_IPVERSION              */
...
#define _CMU_CLKEN1_MASK                           0x3FFFFFFFUL                              /**< Mask for CMU_CLKEN1                         */
...
#define CMU_CLKEN1_MVP                             (0x1UL << 29)                             /**< Enable Bus Clock                            */
#define _CMU_CLKEN1_MVP_SHIFT                      29                                        /**< Shift value for CMU_MVP                     */
#define _CMU_CLKEN1_MVP_MASK                       0x20000000UL                              /**< Bit mask for CMU_MVP                        */
#define _CMU_CLKEN1_MVP_DEFAULT                    0x00000000UL                              /**< Mode DEFAULT for CMU_CLKEN1                 */
#define CMU_CLKEN1_MVP_DEFAULT                     (_CMU_CLKEN1_MVP_DEFAULT << 29)           /**< Shifted mode DEFAULT for CMU_CLKEN1         */
...
#define _CMU_TRACECLKCTRL_CLKSEL_DISABLE           0x00000000UL                                /**< Mode DISABLE for CMU_TRACECLKCTRL           */
#define _CMU_TRACECLKCTRL_CLKSEL_SYSCLK            0x00000001UL                                /**< Mode SYSCLK for CMU_TRACECLKCTRL            */
#define _CMU_TRACECLKCTRL_CLKSEL_HFRCOEM23         0x00000002UL                                /**< Mode HFRCOEM23 for CMU_TRACECLKCTRL         */
#define _CMU_TRACECLKCTRL_CLKSEL_HFRCODPLLRT       0x00000003UL                                /**< Mode HFRCODPLLRT for CMU_TRACECLKCTRL       */
#define CMU_TRACECLKCTRL_CLKSEL_DEFAULT            (_CMU_TRACECLKCTRL_CLKSEL_DEFAULT << 0)     /**< Shifted mode DEFAULT for CMU_TRACECLKCTRL   */
#define CMU_TRACECLKCTRL_CLKSEL_DISABLE            (_CMU_TRACECLKCTRL_CLKSEL_DISABLE << 0)     /**< Shifted mode DISABLE for CMU_TRACECLKCTRL   */
...
/** @} End of group EFR32FG28_CMU_BitFields */
/** @} End of group EFR32FG28_CMU */
/** @} End of group Parts */

#endif // EFR32FG28_CMU_H
